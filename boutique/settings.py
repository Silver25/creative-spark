...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    'creative-bliss-7f2ee6904dd8.herokuapp.com',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # next line required by allauth - do NOT remove
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'creativebliss'
...
DEFAULT_FROM_EMAIL = 'creativebliss@test.com'


if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'creativebliss@example.com'
